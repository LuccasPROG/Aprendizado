...
# print(calendar.calendar(2019)) # mostra o calendario do ano
# print(calendar.month(2012, 12)) #mostra um mes especifico do ano

numero_primeiro_dia, ultimo_dia = (calendar.monthrange(2022,7))
